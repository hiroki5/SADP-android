...
public class TopActivity extends FragmentActivity implements OnPageChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(TopActivity.this, top.class);
		...
		button2.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(TopActivity.this, TimeTableActivity.class);
				startActivity(intent);
				}
			});
	}
